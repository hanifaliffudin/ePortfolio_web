...
<div class="md:container md:mx-auto">
  ...
  <div class="bg-gray-300 rounded-md p-4 mb-8">
    ...
    <div class="bg-white p-3 rounded-md">
      I am currently studying at Higher Colleges of Technology major in Quality
      and Strategic Management, where I am actively involved in different
      courses related to the subject job. My recent volunteer activities in your
      company last year was including documentation of different projects and
      other activities like setting up quality testing parameters. I really
      would like to work for a company that offers learning opportunities and
      developing my quality skills.
    </div>
  </div>
  ...
  <div class="bg-gray-300 rounded-md p-4 mb-8">
    ...
    <div class="bg-white p-3 rounded-md"><br /><br /></div>
